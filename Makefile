...
CC = gcc
FILES =\
graphics/meshes/mesh_vao.c\
graphics/meshes/mesh.c\
graphics/camera.c\
graphics/models/model_mesh.c\
graphics/models/model_v_position.c\
graphics/models/model.c\
graphics/models/model_v_texcoord.c\
graphics/models/model_v_normal.c\
graphics/models/model_indices_parser.c\
graphics/models/model_indices.c\
graphics/display.c\
graphics/texture.c\
